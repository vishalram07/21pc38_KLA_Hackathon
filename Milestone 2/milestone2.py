...
import operator
import operator
file1 = open('Milestone 2\Testcase2.txt', 'r')
file2 = open('Milestone 2\Testcase2_out.txt','w')
...
wafer_center = (0,0)
valid_dies = []
die_center = (-WaferDiameter/2+ DieSize[1]/2,WaferDiameter/2-DieSize[0]/2)

for i in range(num_dies_x):
    curr=(die_center[0]+DieSize[1]*i,die_center[1])
    for j in range(num_dies_y+1):
